...
export default function HowToUse() {
  ...
  return (
    <section id="how-to-use" className="mt-30 flex flex-col items-center justify-center gap-4">
    ...
    <div id="how-to-use" className=" grid grid-cols-1 md:grid-cols-4 items-center justify-center gap-8 mt-10">
      {steps.map((step,index)=>(
        <div key={index} className="flex relative z-10 flex-col gap-4 p-6 border border-pink-600 rounded-2xl shadow-md hover:shadow-lg
