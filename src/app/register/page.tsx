  ...
  return (
    <FadeIn>
      <div className="min-h-screen flex items-center justify-center p-4 sm:p-6">
        <div className="w-full max-w-4xl flex flex-col md:flex-row min-h-0 md:min-h-137.5 bg-transparent md:bg-white rounded-none md:rounded-xl shadow-none md:shadow-lg md:shadow-pink-300/30 overflow-hidden">
          {/* Left Div */}
          <div
          ...
          >
            <h1 className="text-4xl font-bold mb-4">
              Create. Share. <span className="text-pink-600">Collect.</span>
            </h1>
          ...
          >
            ...
            >
              ...
              <input
                ...
                required
                className=" w-full bg-zinc-950 outline-none focus:border-pink-600 text-white placeholder:text-zinc-600 border border-zinc-800 rounded-md p-2.5 mb-2 text-sm transition
              "
              />
